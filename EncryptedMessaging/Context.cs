...
namespace EncryptedMessaging
{
    ...
    public enum Modality
    {
        ...
        SaveContacts = 2,
        /// <summary>
        /// Load contacts at startyp: Indicates whether the contacts are to be loaded into the address book ad startup of application (pre load funzion tipical for client application).
    ...
    public class Context:IDisposable
    {
        ...
        internal void OnContactEventInvoke(Message message)
        {
            if (!Modality.HasFlag(Modality.LoadContacts))
                ...
                InvokeOnMainThread(() => OnContactEvent?.Invoke(message));
        }
        /// <summary>
...
#endif
            if (!OnConnectivityChangeIsAssigned)
            {
        ...
        internal static bool InternetAccess => _internetAccess;
        ...
        private bool OnConnectivityChangeIsAssigned;
        /// <summary>
