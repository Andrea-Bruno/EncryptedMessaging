...
namespace EncryptedMessaging
{
    ...
    public class Messaging
    {
        ...
        {
            SendMessageQueue = new Queue<SendMessageParameters>();
        ...
        /// <summary>
        /// When a message is received, it performs the required operations based on the type of message received
        /// </summary>
        /// <param name="chatId">The conversation group in which the message was generated</param>
        /// <param name="message">Message received by the router and generated by a chat member</param>
        ...
        public void SendMessage(MessageType type, byte[] data, Contact toContact, ulong? replyToPostId = null, ulong? chatId = null, ulong[] toIdUsers = null, bool directlyWithoutSpooler = false, bool encrypted = true, bool isLogin = false)
        {
            if (toIdUsers != null)
            {
                ...
                if (chatId == null)
                {
                    chatId = ContactConverter.UserIdsToChatId(toIdUsers);
                }
            }
        ...
        internal Queue<SendMessageParameters> SendMessageQueue;
        ...
        /// To read the data on the target client/server: var values = Functions.SplitData(true,data);
        /// </summary>
        /// <param name="chatId">Id of the chat. Parameter that can be omitted for chats between two users or for groups by default (lacking a descriptive name)</param>
