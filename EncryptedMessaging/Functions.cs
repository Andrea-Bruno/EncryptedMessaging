...
namespace EncryptedMessaging
{
	...
	public static class Functions
	{
		...
		public static string DateToRelative(DateTime date)
		{
			...
			return distance.TotalDays >= 2 ? ((int)distance.TotalDays).ToString(CultureInfo.InvariantCulture) + " " + Dictionary.Days + " " + Dictionary.Ago
					 : distance.TotalDays >= 1 ? ((int)distance.TotalDays).ToString(CultureInfo.InvariantCulture) + " " + Dictionary.Day + " " + Dictionary.Ago
					 : distance.TotalHours >= 2 ? ((int)distance.TotalHours).ToString(CultureInfo.InvariantCulture) + " " + Dictionary.Hours + " " + Dictionary.Ago
					 : distance.TotalHours >= 1 ? ((int)distance.TotalHours).ToString(CultureInfo.InvariantCulture) + " " + Dictionary.Hour + " " + Dictionary.Ago
					 : distance.TotalMinutes >= 5 ? ((int)distance.TotalMinutes).ToString(CultureInfo.InvariantCulture) + " " + Dictionary.Minutes + " " + Dictionary.Ago
