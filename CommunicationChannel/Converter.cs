...
namespace CommunicationChannel
{
	...
	public static class Converter
	{
		...
		public static byte[] StringToByteArray(string text) => !string.IsNullOrEmpty(text) ? Encoding.GetEncoding("utf-16LE").GetBytes(text) : null;
		/// <summary>
		/// convert byte array to string
		/// </summary>
		/// <param name="bytes"> byte array </param>
		/// <returns>string</returns>
		public static string ByteArrayToString(byte[] bytes) => Encoding.GetEncoding("utf-16LE").GetString(bytes);// Unicode encoding
		/// <summary>
