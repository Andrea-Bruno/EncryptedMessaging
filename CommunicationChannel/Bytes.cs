...
namespace CommunicationChannel
{
    ...
    public static class Bytes
    {
        ...
        /// </summary>
        /// <param name="me">Array to reverse</param>
        ...
        public static byte[] GetBytesFromASCII(this string me) => Encoding.ASCII.GetBytes(me);
        /// <summary>
        /// Get unicode from byte array.
        /// </summary>
        /// <param name="me">byte array</param>
        /// <returns> unicode string </returns>
        public static string ToUnicode(this byte[] me) => Encoding.Unicode.GetString(me);
        /// <summary>
        /// Get ASCII from byte array.
        /// </summary>
        /// <param name="me">byte array</param>
        /// <returns> ASCII</returns>
        public static string ToASCII(this byte[] me) => Encoding.ASCII.GetString(me);
        ...
        ///<inheritdoc cref="GetBytes(int)"/>
        public static byte[] GetBytes(this short value) => Converter.GetBytes(value);
        ///<inheritdoc cref="GetBytes(int)"/>
        public static byte[] GetBytes(this ushort value) => Converter.GetBytes(value);
        ///<inheritdoc cref="GetBytes(int)"/>
        public static byte[] GetBytes(this string me) => me == null ? Array.Empty<byte>() : Encoding.Unicode.GetBytes(me);
    }
}